...
def club_window():
    ...
    def club_meeting():
        ...
        srch_btn=Button(display_frame,text="Search",font=myFont3,bd=3,relief=GROOVE,command=lambda:search_meeting(connection,clb_meet_tb,srch_var,srch_entry_var)).grid(row=0,column=3,padx=10)
    ...
    def club_recr():
        ...
        srch_btn=Button(display_frame,text="Search",font=myFont3,bd=3,relief=GROOVE,command=lambda:search_recruitment(connection,clb_rec_tb,srch_var,srch_entry_var)).grid(row=0,column=3,padx=10)
...
Events_btn= Button(c2,text="Events",font=myFont1,relief=SOLID,borderwidth=1,height=1,width=12,activebackground='#e5e5e5',bg='#fca311',command=lambda:event_window(root,connection))
Events_btn.pack(pady=15)
admin_btn= Button(c3,text= "Admin",font=myFont1,relief=SOLID,borderwidth=1,height=1,width=12,activebackground='#e5e5e5',bg='#fca311',command=lambda:login(root,connection))
