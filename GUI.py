...
def club_window():
   ...
   info_btn= Button(btn_frame,text="Information",font=myFont1,relief=SOLID,borderwidth=1,height=1,width=12,activebackground='#ffffff',bg='pale turquoise')
   info_btn.grid(row=0, column=0,padx=4,pady=4)
   recr_btn= Button(btn_frame,text="Recruitment",font=myFont1,relief=SOLID,borderwidth=1,height=1,width=12,activebackground='#ffffff',bg='pale turquoise')
   recr_btn.grid(row=0, column=1)
   meet_btn= Button(btn_frame,text= "Meeting",font=myFont1,relief=SOLID,borderwidth=1,height=1,width=12,activebackground='#ffffff',bg='pale turquoise')
   meet_btn.grid(row=1, column=0,padx=4)
   return_btn= Button(btn_frame,text= "Return",font=myFont1,relief=SOLID,borderwidth=1,height=1,width=12,activebackground='#ffffff',bg='pale turquoise',command=func)
...
btn_frame= Frame(main_frame,bg="pale turquoise")
btn_frame.pack()
clubs_btn= Button(btn_frame,text="Clubs",font=myFont1,relief=SOLID,borderwidth=1,height=1,width=12,activebackground='#ffffff',bg='pale turquoise',command=club_window)
clubs_btn.grid(row=0, column=0,padx=4,pady=4)
Events_btn= Button(btn_frame,text="Events",font=myFont1,relief=SOLID,borderwidth=1,height=1,width=12,activebackground='#ffffff',bg='pale turquoise')
Events_btn.grid(row=0, column=1)
admin_btn= Button(btn_frame,text= "Admin",font=myFont1,relief=SOLID,borderwidth=1,height=1,width=12,activebackground='#ffffff',bg='pale turquoise')
admin_btn.grid(row=1, column=0,padx=4)
exit_btn= Button(btn_frame,text= "Exit",font=myFont1,relief=SOLID,borderwidth=1,height=1,width=12,activebackground='#ffffff',bg='pale turquoise',command=root.destroy)
