...
FUNCTION INSERT_CLUB(CLUB_NAME IN VARCHAR,CONVENER IN VARCHAR,S_MEDIA IN VARCHAR,CLUB_DESCRIPTION IN VARCHAR) RETURN BOOLEAN;
...
FUNCTION INSERT_MEETING(C_NAME VARCHAR,M_DATE TIMESTAMP,VENUE VARCHAR,DESCRIPTION VARCHAR) RETURN BOOLEAN;
FUNCTION INSERT_EVENT(E_NAME VARCHAR,E_DATE TIMESTAMP,VENUE VARCHAR,DESCRIPTION VARCHAR,C_NAME VARCHAR) RETURN BOOLEAN;
FUNCTION UPDATE_CLUB(CLUB_NAME VARCHAR,CONVENER VARCHAR,S_MEDIA VARCHAR,CLUB_DESCRIPTION VARCHAR) RETURN BOOLEAN;
FUNCTION UPDATE_CO_CONVENER(CO_NAME VARCHAR,C_NAME VARCHAR) RETURN BOOLEAN;
FUNCTION UPDATE_RECRUITMENT(C_NAME VARCHAR,R_DATE TIMESTAMP,VENUE VARCHAR) RETURN BOOLEAN;
FUNCTION UPDATE_MEETING(C_NAME VARCHAR,M_DATE TIMESTAMP,VENUE VARCHAR,DESCRIPTION VARCHAR) RETURN BOOLEAN;
FUNCTION UPDATE_EVENT(E_ID NUMBER,E_NAME VARCHAR,E_DATE TIMESTAMP,VENUE VARCHAR,DESCRIPTION VARCHAR,C_NAME VARCHAR) RETURN BOOLEAN;
FUNCTION DELETE_CLUB(CLUB_NAME VARCHAR) RETURN BOOLEAN;
FUNCTION DELETE_CO_CONVENER(CO_NAME VARCHAR,C_NAME VARCHAR) RETURN BOOLEAN;
FUNCTION DELETE_RECRUITMENT(C_NAME VARCHAR,R_DATE TIMESTAMP) RETURN BOOLEAN;
FUNCTION DELETE_MEETING(C_NAME VARCHAR,M_DATE TIMESTAMP) RETURN BOOLEAN;
FUNCTION DELETE_EVENT(E_ID NUMBER,E_DATE TIMESTAMP) RETURN BOOLEAN;
END CLUB_PACK;
/
CREATE OR REPLACE PACKAGE BODY CLUB_PACK AS
FUNCTION INSERT_CLUB(CLUB_NAME VARCHAR,CONVENER VARCHAR,S_MEDIA VARCHAR,CLUB_DESCRIPTION VARCHAR) RETURN BOOLEAN
AS
    BEGIN
...
AS
    BEGIN
    INSERT INTO EVENT VALUES(E_ID,E_NAME,E_DATE,VENUE,DESCRIPTION,C_NAME);
    RETURN TRUE;
    EXCEPTION
    WHEN DUP_VAL_ON_INDEX THEN
        UPDATE EVENT
